$(document).ready(function() {
  const apiRoot = 'https://kodilla-tasks-pstruzyn.herokuapp.com/v1/tasks/';
  const trelloApiRoot = 'https://api.trello.com/1/members/pstruz89';
  ...
  function getAllAvailableBoards(callback, callbackArgs) {
    var requestUrl = trelloApiRoot + '/boards?fields=name,id&lists=all&key=7d2d6f5907b15905e4eef8079e832675&token=7107956229f4b44d01acf0f596f2d77b4e36f6128870af2a90b584fb5837ef88';
  ...
  function handleCardCreationRequest(event) {
    var requestUrl = trelloApiRoot + '/cards?key=7d2d6f5907b15905e4eef8079e832675&token=7107956229f4b44d01acf0f596f2d77b4e36f6128870af2a90b584fb5837ef88';
